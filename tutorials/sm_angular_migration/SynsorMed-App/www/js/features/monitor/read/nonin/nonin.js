angular.module('synsormed.controllers.monitor.nonin', [
...
.controller('bluetoothNoninDeviceController', [
    ...
    function($scope, metaData, $modalInstance, $cordovaBluetoothLE, Nonin, BluetoothService, BluetoothStorageService){
        ...
        $scope.connectDevice = function(address, deviceName){
            ...
            .then(function(connection){
                ...
                console.log("**** Before readNoninData, we want the following targetServices: " + JSON.stringify(targetServices));
            ...
            .then(function(deviceData){
                ...
                console.log('Nonin final data is');
