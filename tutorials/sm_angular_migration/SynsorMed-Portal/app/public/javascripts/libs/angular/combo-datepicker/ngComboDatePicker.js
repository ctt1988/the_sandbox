...
.directive('ngComboDatePicker', function() {
    return {
        ...
        template: function() {
            var html =
                '<select class="btn btn-default text-center" ng-model="date" ng-change="onChange(\'date\')" ng-options="date for date in dates"></select>'+
                '<select class="btn btn-default text-center" ng-model="month" ng-change="onChange(\'month\')" ng-options="month.index as month.name for month in months"></select>'+
                '<select class="btn btn-default text-center" ng-model="year" ng-change="onChange(\'year\')" ng-options="year for year in years"></select>';
            return html;
        }
    }
});
